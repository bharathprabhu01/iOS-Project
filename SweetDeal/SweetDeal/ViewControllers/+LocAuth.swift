...
extension StuMainViewController {
    ...
    func createGeoFence(restaurant: Restaurant) {
        ...
        let geoFenceRegion: CLCircularRegion = CLCircularRegion(center: CLLocationCoordinate2DMake(CLLocationDegrees(resLat), CLLocationDegrees(resLong)), radius: 100, identifier: "\(resName)")
